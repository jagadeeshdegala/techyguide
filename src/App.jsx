...
function HomePage() {
  useEffect(() => {
    ...
    const preloadRoutes = () => {
      import('./ImpactProgram.jsx');
      import('./productPages/I-BoT.jsx');
      import('./productPages/TeBoT.jsx');
      import('./productPages/E-Blox.jsx');
      import('./productPages/AddOnKit.jsx');
      import('./FranchisePage.jsx');
      import('./RobothronePage.jsx');
      import('./ForschoolsPages/AI-RoboticLabCBSE.jsx');
      import('./ForschoolsPages/AI-RoboticLabICSE.jsx');
      import('./ForschoolsPages/StemLab.jsx');
      import('./ForschoolsPages/StemTinkeringLab.jsx');
      import('./ForschoolsPages/CompositeSkillLab.jsx');
      import('./ForschoolsPages/WorkshopPage.jsx');
      import('./coursesPage.jsx');
      import('./ShopPage.jsx');
      import('./CheckOutPage.jsx');
      import('./PaymentSuccess.jsx');
      import('./privacyPolicypage.jsx');
      import('./AboutUsPage.jsx');
      import('./partnersPage.jsx');
      import('./contactUs.jsx');
      import('./CareersPage.jsx');
      import('./404');
    };

    let preloadTimer;
    if ('requestIdleCallback' in window) {
      window.requestIdleCallback(preloadRoutes, { timeout: 1500 });
    } else {
      preloadTimer = window.setTimeout(preloadRoutes, 700);
    }
