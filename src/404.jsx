...
function NotFound() {
  ...
  useEffect(() => {
    ...
    const prevTopBarDisplay = topBar ? topBar.style.display : "";
    const prevHeaderDisplay = header ? header.style.display : "";
    const prevWhatsappDisplay = whatsappButton ? whatsappButton.style.display : "";
    ...
    if (!canvas || !ctx) {
      return () => {
        ...
        if (whatsappButton) whatsappButton.style.display = prevWhatsappDisplay;
